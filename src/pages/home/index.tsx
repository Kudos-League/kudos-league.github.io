            ...
            <div className='flex items-start gap-4 mb-4'>
                ...
                <div className='flex-1'>
                    ...
                    <p className='text-sm text-gray-700 dark:text-gray-300 leading-relaxed mb-4'>
                        ...
                        help. Share what you have, request what you need, and
                    ...
                    <ul className='hidden sm:flex sm:flex-col sm:space-y-2 mb-4 text-sm text-gray-600 dark:text-gray-400'>
                        ...
                        <li className='flex items-start gap-2'>
                            ...
                            <span>
                                Earn kudos points for every contribution
                            </span>
                        </li>
                    </ul>
                </div>
                            ...
                            <div className='relative'>
                                ...
                                {filterOpen && (
                                    <>
                                        ...
                                        />
                                        <div
                                            className={`absolute ${windowWidth >= 373 ? 'right-0' : 'left-0'} mt-2 w-48 max-w-[calc(100vw-2rem)] bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-lg shadow-lg z-20 overflow-hidden`}
                                        >
                                            <button
                        ...
                        <div className='bg-blue-50 border border-blue-400 rounded-lg p-4 flex items-start gap-3 dark:bg-blue-900/30 dark:border-blue-800'>
                            ...
                            <div className='flex-1'>
                                ...
                                <p className='text-sm text-blue-800 dark:text-blue-400'>
                                    To sort by distance, you need to set your
                                    location in your profile first. Go to your
                                    profile, click &quot;Edit&quot;, and add
                                    your location.
                                </p>
                            </div>
                            <Button
                    ...
                    <>
                        ...
                        <div className='mb-4 text-center'>
                            <p className='text-sm text-gray-600 dark:text-gray-400 font-medium'>
                                Below you can see what people are doing right
                                now
                            </p>
                        </div>
                            ...
                            <div className='bg-blue-50 border border-blue-400 rounded-lg p-4 flex items-start gap-3 dark:bg-blue-900/30 dark:border-blue-800'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-sm text-blue-800 dark:text-blue-400'>
                                        ...
                                        Please log in and add your location to
                                        use this feature.
                                    </p>
                                </div>
                                <Button
                        ...
                        {showLocationWarning && (
                            <div className='bg-blue-50 border border-blue-400 rounded-lg p-4 flex items-start gap-3 dark:bg-blue-900/30 dark:border-blue-800'>
                                ...
                                <div className='flex-1'>
                                    ...
                                    <p className='text-sm text-blue-800 dark:text-blue-400'>
                                        To sort by distance, you need to set
                                        your location in your profile first. Go
                                        to your profile, click &quot;Edit&quot;,
