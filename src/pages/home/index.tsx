...
function AboutCTA({
    ...
    return (
        <div className='bg-gradient-to-br from-brand-50 to-blue-50 dark:from-brand-900/20 dark:to-blue-900/20 border border-brand-200 dark:border-brand-800 rounded-xl p-6 shadow-lg my-2'>
