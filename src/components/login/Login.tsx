...
export default function LoginForm({ onSuccess, onError }: LoginFormProps) {
  ...
  const { register: formRegister, handleSubmit, setValue } = useForm<FormValues>();
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="text-right text-sm mb-2">
            <button type="button" onClick={() => navigate("/forgot-password")} className="text-blue-500">
              Forgot password?
            </button>
          </div>
          ...
          <div className="text-center text-sm mt-4">
            ...
            <button type="button" onClick={() => navigate("/sign-up")} className="text-blue-500 font-bold">
              Sign Up
            </button>
          </div>
