    ...
    return (
        <>
            <button
                ...
                className='fixed bottom-6 left-6 z-40 w-12 h-12 rounded-full bg-purple-600 hover:bg-purple-700 text-white flex items-center justify-center shadow-lg transition-all'
                title='Dev Tools'
            >
                ⚙️
            </button>
            ...
            {isOpen && (
                <div className='fixed bottom-24 left-6 z-40 w-96 max-h-96 bg-white dark:bg-slate-800 rounded-lg shadow-xl overflow-hidden flex flex-col border border-purple-200 dark:border-purple-900'>
                    ...
                    <div className='flex border-b border-purple-200 dark:border-purple-900'>
                        <button
