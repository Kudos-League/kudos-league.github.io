  ...
  return (
    <div className="flex mb-4 p-3 bg-gray-100 rounded-lg">
      {message.author?.avatar && (
        <div style={{ width: 50, height: 50, borderRadius: "50%", marginRight: 10, overflow: "hidden", flexShrink: 0 }}>
          <AvatarComponent
      ...
      <div className="flex-1 ml-3">
        ...
        <div className="text-xs text-gray-500">Kudos: {message.author?.kudos}</div>
