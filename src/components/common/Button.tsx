...
const variantClasses: Record<Variant, string> = {
    ...
    danger:
        'bg-red-600 text-white shadow-xs hover:bg-red-500 focus-visible:outline-red-600 dark:bg-red-500 dark:hover:bg-red-400',
    warning:
    ...
    info:
        'bg-sky-600 text-white shadow-xs hover:bg-sky-500 focus-visible:outline-sky-600 dark:bg-sky-500 dark:hover:bg-sky-400',
    icon:
        'bg-indigo-600 text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400',
};
...
export default function Button({
    ...
    return (
        <button
            {...props}
            className={clsx(baseClasses, variantClasses[variant], shapeClasses[shape], className)}
        >
            {children}
        </button>
    );
