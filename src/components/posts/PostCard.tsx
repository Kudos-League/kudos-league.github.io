...
export default function PostCard(props: Props) {
    ...
    const imageSrc = fake ? images?.[0] : images?.[0] ?
        getImagePath(images[0]) : undefined;
            ...
            <div className="flex justify-between items-start gap-4 w-full">
                <div className="flex-1 pr-4 w-4/5">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h2 className="text-lg font-bold break-words text-gray-800 dark:text-gray-100">{title}</h2>
                    </div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-3 mr-2 break-words">{body}</p>
                </div>
